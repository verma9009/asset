                       ...
                       <div style="display: flex; margin-bottom: 3px;" >
                           ...
                           <div className="input-group" style="display: flex; display:contents;" >
                               <input type="text" className="bg-light border-0 small" placeholder="Search by name.."
                                   aria-label="Search" aria-describedby="basic-addon2" style="margin-left: 20pc;width: 15pc;"/>
                            ...
                            <table className="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>emp1</td>
                                        <td>
                                            <button className="btn btn-success ">Assigned</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="./View_Assets.html">
                                              <button className="btn btn-danger">UnAssigned</button>
